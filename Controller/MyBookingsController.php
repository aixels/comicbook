...
class MyBookingsController extends Controller
{
    ...
    public function cancel(Request $request)
    {
        ...
        $msg[] = __('eventmie-pro::em.cancellation_and_refund') . ' - ' . $cancellation_msg;
        $extra_lines = $msg;

        $mail['mail_subject'] = __('eventmie-pro::em.booking_cancellation_and_refund');
        $mail['mail_message'] = __('eventmie-pro::em.booking_cancellation_processing_and_refund');
